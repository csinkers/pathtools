...
#v::
    ...
    else if FileExist("C:\Program Files\Microsoft Visual Studio\2022\Professional\Common7\IDE\devenv.exe")
    ...
    else if FileExist("C:\Program Files (x86)\Microsoft Visual Studio\2019\Professional\Common7\IDE\devenv.exe")
